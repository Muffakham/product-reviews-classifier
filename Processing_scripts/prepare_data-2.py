...
###################################################### Setup AWS environmental variables ###########################################################
...
# for AWS sagemaker feature store
...
# function to Convert the review into the BERT input ids using
...
def _preprocess_file(file, 
    ...
    # first the row values are converted to string
